...
locals {
  ...
  topic     = "demo-topic"
  topic_arn = "arn:aws:kafka:${data.aws_region.current.region}:${var.msk_aws_account_id}:topic/${var.name_prefix}-msk/${module.msk_cluster.cluster_uuid}/*"
  group_arn = "arn:aws:kafka:${data.aws_region.current.region}:${var.msk_aws_account_id}:group/${var.name_prefix}-msk/${module.msk_cluster.cluster_uuid}/*"
}
